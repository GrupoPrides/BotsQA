...
function createModal(){
    ...
    divContent.innerHTML = '<span class="close">&times;</span><p>Para poder utilizar el servicio de chat debe tener lo cookies activados, puede seguir la guia de como activarlos en el siguiente enlace. <a href="https://www.grupoprides.com">GUIA</a></p>'
